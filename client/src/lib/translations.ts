export const translations = {
  de: {
    nav: {
      mirror: "Der Spiegel",
      pivot: "Der Wendepunkt",
      authority: "Die Autorität",
      contact: "Kontakt"
    },
    hero: {
      title: "Nach Hause kommen",
      subtitle: "zu sich selbst.",
      description: "Ihre Stärken und Bestimmung wiederentdecken – jenseits von Rollen, Routinen und Verpflichtungen."
    },
    narrative: {
    ...
    methodology: {
      ...
      p2: "Meine Mission: Klarheit für ihren Lebensweg gewinnen und ihnen helfen, die Frau zu leben, die sie schon immer sein wollten."
    },
    authority: {
      label: "Die Autorität",
    ...
    trust: {
      ...
      languages: "Fließend in 5 Sprachen",
      luxury: "25+ Jahre Luxus-Expertise",
      resilience: "4-fache Mutter & Resilienz-Expertin"
    },
    contact: {
      title: "Dies ist Ihre Zeit.",
      description: "Sich selbst zu wählen. Ihr nächstes Kapitel mit Klarheit und Zuversicht zu gestalten.",
      label: "Private Anfrage",
  ...
  en: {
    ...
    hero: {
      title: "Coming Home",
      subtitle: "to Yourself.",
      description: "Rediscovering your strengths and purpose beyond roles, routines, and responsibilities."
    },
    narrative: {
      quote: "\"Where am I in all of this?\"",
      p1: "Many women over 40 find themselves in the space between 'everything looks fine' and 'something is missing on the inside.'",
      p2: "Between responsibility, expectations, and years of caring for others, a deeper question surfaces: Where am I in all of this?",
      p3: "This is where I guide you: A journey of reconnecting with the woman you are—behind roles, routines, and responsibilities."
    },
    methodology: {
      label: "The Pivot",
      title: "Your Next Chapter,",
      subtitle: "Defined.",
      p1: "I specialize in empowering mature women to rediscover their untapped, inner potential. Whether you are ready to redefine your business, reestablish relationships built on mutual respect, or step fully into your leadership confidence—I accomodate you.",
      p2: "My calling is to help you gain clarity about your professional and personal lifepath, and to transform you into the woman that you always wanted to be."
    },
    authority: {
      label: "The Authority",
      title: "CH Executive Coaching Meets",
      subtitle: "Personal Transformation.",
      p1: "I am Chantal Hammer—an entrepreneur with over 25 years in the luxury sector and a certified INSEAD Executive Coach. My background in Retail and Consumer Goods, supported by a B.Sc. in Business and Economics, shapes my strategic and commercial perspective.",
    ...
    trust: {
      ...
      luxury: "25+ Years Luxury Leadership",
      resilience: "Mother of 4 & Resilience Expert"
    },
    contact: {
      title: "This is your time.",
      description: "To choose yourself. To create your next chapter with clarity and confidence.",
